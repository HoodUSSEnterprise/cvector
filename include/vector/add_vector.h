...
// 加法宏
#define add_vec(v1, v2) _Generic((v1), \
    Vectorc *: _Generic((v2),          \
        Vectorc *: add_vectorc_c,      \
        Vectord *: add_vectorc_d,      \
        Vectorf *: add_vectorc_f,      \
        Vectori *: add_vectorc_i,      \
        Vector3c *: add_vectorc_3c,    \
        Vector3d *: add_vectorc_3d,    \
        Vector3f *: add_vectorc_3f,    \
        Vector3i *: add_vectorc_3i,    \
        Vector2c *: add_vectorc_2c,    \
        Vector2d *: add_vectorc_2d,    \
        Vector2f *: add_vectorc_2f,    \
        Vector2i *: add_vectorc_2i),   \
    Vectord *: _Generic((v2),          \
        Vectorc *: add_vectord_c,      \
        Vectord *: add_vectord_d,      \
        Vectorf *: add_vectord_f,      \
        Vectori *: add_vectord_i,      \
        Vector3c *: add_vectord_3c,    \
        Vector3d *: add_vectord_3d,    \
        Vector3f *: add_vectord_3f,    \
        Vector3i *: add_vectord_3i,    \
        Vector2c *: add_vectord_2c,    \
        Vector2d *: add_vectord_2d,    \
        Vector2f *: add_vectord_2f,    \
        Vector2i *: add_vectord_2i),   \
    Vectorf *: _Generic((v2),          \
        Vectorc *: add_vectorf_c,      \
        Vectord *: add_vectorf_d,      \
        Vectorf *: add_vectorf_f,      \
        Vectori *: add_vectorf_i,      \
        Vector3c *: add_vectorf_3c,    \
        Vector3d *: add_vectorf_3d,    \
        Vector3f *: add_vectorf_3f,    \
        Vector3i *: add_vectorf_3i,    \
        Vector2c *: add_vectorf_2c,    \
        Vector2d *: add_vectorf_2d,    \
        Vector2f *: add_vectorf_2f,    \
        Vector2i *: add_vectorf_2i),   \
    Vectori *: _Generic((v2),          \
        Vectorc *: add_vectori_c,      \
        Vectord *: add_vectori_d,      \
        Vectorf *: add_vectori_f,      \
        Vectori *: add_vectori_i,      \
        Vector3c *: add_vectori_3c,    \
        Vector3d *: add_vectori_3d,    \
        Vector3f *: add_vectori_3f,    \
        Vector3i *: add_vectori_3i,    \
        Vector2c *: add_vectori_2c,    \
        Vector2d *: add_vectori_2d,    \
        Vector2f *: add_vectori_2f,    \
        Vector2i *: add_vectori_2i),   \
    Vector3c *: _Generic((v2),         \
        Vectorc *: add_vector3c_c,     \
        Vectord *: add_vector3c_d,     \
        Vectorf *: add_vector3c_f,     \
        Vectori *: add_vector3c_i,     \
        Vector3c *: add_vector3c_3c,   \
        Vector3d *: add_vector3c_3d,   \
        Vector3f *: add_vector3c_3f,   \
        Vector3i *: add_vector3c_3i,   \
        Vector2c *: add_vector3c_2c,   \
        Vector2d *: add_vector3c_2d,   \
        Vector2f *: add_vector3c_2f,   \
        Vector2i *: add_vector3c_2i),  \
    Vector3d *: _Generic((v2),         \
        Vectorc *: add_vector3d_c,     \
        Vectord *: add_vector3d_d,     \
        Vectorf *: add_vector3d_f,     \
        Vectori *: add_vector3d_i,     \
        Vector3c *: add_vector3d_3c,   \
        Vector3d *: add_vector3d_3d,   \
        Vector3f *: add_vector3d_3f,   \
        Vector3i *: add_vector3d_3i,   \
        Vector2c *: add_vector3d_2c,   \
        Vector2d *: add_vector3d_2d,   \
        Vector2f *: add_vector3d_2f,   \
        Vector2i *: add_vector3d_2i),  \
    Vector3f *: _Generic((v2),         \
        Vectorc *: add_vector3f_c,     \
        Vectord *: add_vector3f_d,     \
        Vectorf *: add_vector3f_f,     \
        Vectori *: add_vector3f_i,     \
        Vector3c *: add_vector3f_3c,   \
        Vector3d *: add_vector3f_3d,   \
        Vector3f *: add_vector3f_3f,   \
        Vector3i *: add_vector3f_3i,   \
        Vector2c *: add_vector3f_2c,   \
        Vector2d *: add_vector3f_2d,   \
        Vector2f *: add_vector3f_2f,   \
        Vector2i *: add_vector3f_2i),  \
    Vector3i *: _Generic((v2),         \
        Vectorc *: add_vector3i_c,     \
        Vectord *: add_vector3i_d,     \
        Vectorf *: add_vector3i_f,     \
        Vectori *: add_vector3i_i,     \
        Vector3c *: add_vector3i_3c,   \
        Vector3d *: add_vector3i_3d,   \
        Vector3f *: add_vector3i_3f,   \
        Vector3i *: add_vector3i_3i,   \
        Vector2c *: add_vector3i_2c,   \
        Vector2d *: add_vector3i_2d,   \
        Vector2f *: add_vector3i_2f,   \
        Vector2i *: add_vector3i_2i),  \
    Vector2c *: _Generic((v2),         \
        Vectorc *: add_vector2c_c,     \
        Vectord *: add_vector2c_d,     \
        Vectorf *: add_vector2c_f,     \
        Vectori *: add_vector2c_i,     \
        Vector3c *: add_vector2c_3c,   \
        Vector3d *: add_vector2c_3d,   \
        Vector3f *: add_vector2c_3f,   \
        Vector3i *: add_vector2c_3i,   \
        Vector2c *: add_vector2c_2c,   \
        Vector2d *: add_vector2c_2d,   \
        Vector2f *: add_vector2c_2f,   \
        Vector2i *: add_vector2c_2i),  \
    Vector2d *: _Generic((v2),         \
        Vectorc *: add_vector2d_c,     \
        Vectord *: add_vector2d_d,     \
        Vectorf *: add_vector2d_f,     \
        Vectori *: add_vector2d_i,     \
        Vector3c *: add_vector2d_3c,   \
        Vector3d *: add_vector2d_3d,   \
        Vector3f *: add_vector2d_3f,   \
        Vector3i *: add_vector2d_3i,   \
        Vector2c *: add_vector2d_2c,   \
        Vector2d *: add_vector2d_2d,   \
        Vector2f *: add_vector2d_2f,   \
        Vector2i *: add_vector2d_2i),  \
    Vector2f *: _Generic((v2),         \
        Vectorc *: add_vector2f_c,     \
        Vectord *: add_vector2f_d,     \
        Vectorf *: add_vector2f_f,     \
        Vectori *: add_vector2f_i,     \
        Vector3c *: add_vector2f_3c,   \
        Vector3d *: add_vector2f_3d,   \
        Vector3f *: add_vector2f_3f,   \
        Vector3i *: add_vector2f_3i,   \
        Vector2c *: add_vector2f_2c,   \
        Vector2d *: add_vector2f_2d,   \
        Vector2f *: add_vector2f_2f,   \
        Vector2i *: add_vector2f_2i),  \
    Vector2i *: _Generic((v2),         \
        Vectorc *: add_vector2i_c,     \
        Vectord *: add_vector2i_d,     \
        Vectorf *: add_vector2i_f,     \
        Vectori *: add_vector2i_i,     \
        Vector3c *: add_vector2i_3c,   \
        Vector3d *: add_vector2i_3d,   \
        Vector3f *: add_vector2i_3f,   \
        Vector3i *: add_vector2i_3i,   \
        Vector2c *: add_vector2i_2c,   \
        Vector2d *: add_vector2i_2d,   \
        Vector2f *: add_vector2i_2f,   \
        Vector2i *: add_vector2i_2i))(v1, v2)
